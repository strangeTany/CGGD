...
void cg::renderer::ray_tracing_renderer::init()
{
	...
	render_target = std::make_shared<
			cg::resource<cg::unsigned_color>>(settings->width, settings->height);
	...
	lights.push_back({float3{-0.24f, 1.8f, -0.16f},
					  float3{0.78f, 0.78f, 0.78f}*0.25f});

	lights.push_back({float3{-0.23f, 1.8f, -0.22f},
					  float3{0.78f, 0.78f, 0.78f}*0.25f});
